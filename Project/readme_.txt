The main project file is the FTP_.py file. Data file is 'electricity_prices.csv'
...
====================================================================================
The toolbox.py or such file not used. All functions are presented in the FTP_.py file.

We can just run FTP_.py. But pleas commend out the lines 1099 till the end or simply put break point on this line of code:
